...
DELETE FROM `creature_loot_template` WHERE `item` IN (2636,55232,57131,60402,60404,60497,60511,60754,60755);
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`, `shared`) VALUES
(1165, 2636, -75, 0, 0, 1, 1, 0),
(1167, 2636, -75, 0, 0, 1, 1, 0),

(41137, 55232, -100, 0, 0, 1, 1, 0),
...
(44176, 60511, -65, 0, 0, 1, 1, 0),
(44292, 60511, -65, 0, 0, 1, 1, 0),
(45401, 60511, -65, 0, 0, 1, 1, 0),
